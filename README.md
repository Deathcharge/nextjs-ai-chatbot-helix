# 💬 Next.js AI Chatbot (Helix Integration)

**Status:** **ACTIVE SUPPORT** - Next.js frontend for the AI Chatbot, integrated with the Helix Collective's agent logic.

## 🚀 **v16.9 Overhaul Pulse Alignment**

This project is aligned with the **Helix Hub v16.9** standard, providing a modern chat interface for agent interaction.

- **Core Function:** Provides a Vercel AI SDK-based chat interface.
- **Integration:** Communicates with the `helix-unified` core via API for agent responses and context.
- **Ethical Base:** Tony Accords (Nonmaleficence, Autonomy, Compassion, Humility).

## 🛠️ **Technical Specifications**

- **Base:** Node.js, Next.js 14+, Vercel AI SDK.
